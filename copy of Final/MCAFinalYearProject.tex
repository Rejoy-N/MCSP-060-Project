...
\begin{center}
	...
	\renewcommand\thetable{2} 					
	\captionof{table}{ \textbf {\small {Requirements - User Module - Registration}}} \label{table:2}
	\vspace{0.25cm}
...
\begin{center}
	...
	\renewcommand\thetable{2} 					
	\captionof{table}{ \textbf {\small {Requirements - User Module - Product Listing \& Search}}} \label{table:2}
	\vspace{0.25cm}
...
\begin{center}
	...
	\renewcommand\thetable{2} 					
	\captionof{table}{ \textbf {\small {Requirements - User Module - Shopping Cart}}} \label{table:2}
	\vspace{0.25cm}
...
\begin{center}
	...
	\renewcommand\thetable{2} 					
	\captionof{table}{ \textbf {\small {Requirements - User Module - Place Order}}} \label{table:2}
	\vspace{0.25cm}
...
\begin{center}
	...
	\hline
	\newFR\label{Em:1}  & User should receive email notification on successful order placement & Email message delivered to user inbox  a & Email notification shall be sent to the registered email address of the customer \newline \newline Email notification shall be sent to the email address of the cardholder making the payment \\
	\hline											
	\end{tabularx}
	}
\end{center}
...
\begin{center}
	...
	\hline	
	1.0 & Manage Session & Unique session is created for every user after login. Session is destroyed after user logs out \\
	\hline			
	2.0 & Shopping Cart & Javascript module for users to add items to shopping cart   \\
	\hline
	3.0 & Product Search & Javsacript function for users to be able to search for products using the name string  \\ [1em]
	\hline
	4.0 & Place Order & Triggers order for the selected items in the Cart. A unique Order ID is generated and details are saved to the Database  \\  [1em]
	\hline	  
	5.0 & Stripe \Gls{Payment Gateway} & \Gls{API} to receive payments for Orders \\ 
	\hline	
	6.0 & Email Notification for Order Confirmation & Automated \gls{email} notification on successful order and successful payment for the order \\ [1em]
	\hline	
	7.0 & Manage Products & Utility to add products to the database that includes the File Upload Handler \\ [1em]
	\hline	 
	8.0 & File Upload Handler & Utility to add Product image when uploading details of a new product  \\ [1em]
	\hline	  
	9.0 & View Orders & Admin user can query and view details of Placed orders  \\ [1em]
	\hline
	10.0 & View Specific Order & Admin user can query and view details of a specific order  \\ [1em]	
	\hline
	\end{tabularx}
	}
\end{center}
...
\begin{minipage}{\textwidth}
	\centering
	\includegraphics[ width=0.7\textwidth , keepaspectratio]{./Images/SS1.png}\\[-1em]
	\vspace{0.25cm}
...
\begin{minipage}{\textwidth}
	\centering
	\includegraphics[ width=\textwidth , keepaspectratio]{./Images/SS2.png}\\[-1em]
	\vspace{0.25cm}
...
\begin{minipage}{\textwidth}
	\centering
	\includegraphics[ width=\textwidth , keepaspectratio]{./Images/SS3.png}\\[-1em]
	\vspace{0.25cm}
